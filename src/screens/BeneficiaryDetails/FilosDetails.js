...
import Logo from '../../../assets/beneficiarylogos/Filos_logo.png';

const FilosDetails = ({ navigation }) => {
    ...
    return (
        <ScrollView style={styles.container}>
            ...
            <Text style={styles.name}>Filos Community Services</Text>
            <View style={styles.infoContainer}>
                <TouchableOpacity style={styles.infoRow} onPress={() => Linking.openURL('filos.sg')}>
                    <Icon name="link" size={24} color="#517fa4" />
                    <Text style={styles.infoText}>Website</Text>
                </TouchableOpacity>
                <View style={styles.infoRow}>
                    <Icon name="email" size={24} color="#517fa4" />
                    <Text style={styles.infoText}>info@filos.sg</Text>
                </View>
                <View style={styles.infoRow}>
                ...
                <View style={styles.section}>
                    ...
                    <Text style={styles.sectionContent}>Others: Persons with mental illness</Text>
