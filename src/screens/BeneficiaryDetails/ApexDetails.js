...
import ApexLogo from '../../../assets/beneficiarylogos/Apex_logo.png';

const ApexDetails = ({ navigation }) => {
    ...
    return (
        <ScrollView style={styles.container}>
            ...
            <Image source={ApexLogo} style={styles.logo} />
