...
async function timeTaken(stopA, stopB) {
    try {
        ...
        const url = `https://maps.googleapis.com/maps/api/directions/json?origin=${stopAString}&destination=${stopBString}&mode=${mode}&departure_time=${departureTime}&key=${apiKey}`;
